...
RUN case "$(uname -m)" in \
    ...
    *) echo 'Unsupported architecture' && exit 1 ;; \
    ...
    echo "Downloading https://download.microsoft.com/download/7/6/d/76de322a-d860-4894-9945-f0cc5d6a45f8/mssql-tools18_18.4.1.1-1_${arch}.apk" && \
    curl -O https://download.microsoft.com/download/7/6/d/76de322a-d860-4894-9945-f0cc5d6a45f8/mssql-tools18_18.4.1.1-1_${arch}.apk && \
